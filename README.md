...
<picture>
  <img src="./assets/overview.png" alt="Method Overview" style="background-color:white; padding:10px; border-radius:8px;">
</picture>
...
```bash
# clone this repo
git clone https://github.com/zhang-shuohao/DeAltHDR.git
cd DeAltHDR

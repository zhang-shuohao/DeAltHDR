...
def test_training_batch_config():
    ...
    for batch_size in batch_sizes:
        of = int(0.3 * batch_size)
        attn = int(0.3 * batch_size)
        mixed = batch_size - of - attn
        print(f"Batch size {batch_size}: optical_flow={of}, attention={attn}, mixed={mixed}")
